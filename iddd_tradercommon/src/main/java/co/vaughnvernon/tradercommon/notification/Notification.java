...
package co.vaughnvernon.tradercommon.notification;
...
public class Notification implements Serializable {
    ...
    public static Notification newInstance(DomainEvent anEvent) {
    	return new Notification(System.nanoTime(), anEvent);
    }
    ...
    protected void setEvent(DomainEvent anEvent) {
        if (anEvent == null) {
        	throw new IllegalArgumentException("The event must be provided.");
        }
    ...
    protected void setTypeName(String aTypeName) {
        if (aTypeName == null || aTypeName.isEmpty()) {
        	throw new IllegalArgumentException("The type name must be provided.");
        }
        if (aTypeName.length() > 100) {
        	throw new IllegalArgumentException("The type name must be 100 characters or less.");
        }
