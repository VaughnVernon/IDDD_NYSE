...
import co.vaughnvernon.nanotrader.application.ApplicationServiceRegistry;
...
public class NanoTraderQuoteBarInterest implements QuoteBarInterest {

	public NanoTraderQuoteBarInterest() {
		super();
	}
