...
package co.vaughnvernon.algotrader.infrastructure.messaging.quotes;
...
public class AlgoTraderQuoteBarInterest implements QuoteBarInterest {

	public AlgoTraderQuoteBarInterest() {
		super();
	}
	...
	public void inform(QuoteBar aQuoteBar) {
		...
		ApplicationServiceRegistry
			...
			.updateStreamingQuoteWith(aQuoteBar);

		DomainEventPublisher.instance().reset();

		ApplicationServiceRegistry
			.vwapApplicationService()
			.fillAlgoOrdersUsing(aQuoteBar);
	}
}
